 ...
 */
package com.domainsurvey.crawler.utils.diff.html.dom;
...
import com.domainsurvey.crawler.utils.diff.html.ancestor.TextOnlyComparator;
import com.domainsurvey.crawler.utils.diff.html.dom.helper.AttributesMap;
...
public class TagNode extends Node implements Iterable<Node> {
     ...
     * @throws IllegalStateException - if the parameter
     ...
     * @throws IllegalStateException - if the provided node has
     ...
     * @throws NullPointerException - if children collection is null
     */
