...
@Component
public class IncomingLinkPaginator extends LinkPaginator {
    ...
    protected SelectJoinStep<? extends Record> baseQuery(DomainPaginationRequest domainPaginationRequest, SelectJoinStep<? extends Record> query) {
        ...
        query
                ...
                .on(String.format("%s.source_id = %s.id", TableType.EDGE.getValue(), TableType.NODE.getValue()))
